    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
            ...
            <div className='w-full'>
                ...
                <input onChange={(e)=>setName(e.target.value)} value={name} className='rounded-full w-full max-w-[500px] px-3 py-2 ' type="text" placeholder='Name' required/>
            </div>
            <div className='w-full'>
            ...
            <div>
                ...
                <input onChange={(e)=>setPrice(e.target.value)} value={price} required className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='25$' min={1}/>
            </div>
            <div>
